...
?>
<?php
	$sql="SELECT * FROM slides WHERE id={$_GET["ids"]}";
		$res=$db->query($sql);
			...
			<div id="section" style="margin-left:10px;">
				...
				<div class="content">
					...
					<?php
						...
						{	
							$sql="update slides set heading='{$_POST["heading"]}',price='{$_POST["price"]}',description='{$_POST["description"]}',page_link='{$_POST["page_link"]}' WHERE id={$_GET["id"]}";
